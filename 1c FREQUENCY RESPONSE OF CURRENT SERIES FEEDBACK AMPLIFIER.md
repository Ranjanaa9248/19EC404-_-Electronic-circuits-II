...
![WhatsApp Image 2025-11-21 at 12 51 09_9ff09a5c](https://github.com/user-attachments/assets/57108f80-a159-4c71-8bbb-819976873c9d)

# Graph


![WhatsApp Image 2025-11-21 at 12 50 59_6a73501e](https://github.com/user-attachments/assets/2be8800f-9e33-4e31-a167-11b8e607b887)
...
|:----:|-------------|:----------------:|:--------------:|
| 1 | Lower cut-off frequency | =f1= 0.6KHz | = f1"= 0.45KHz |
| 2 | Upper cut-off frequency | = f2=300KHz | = f2"= 400KHz |
| 3 | Bandwidth | \( BW = fh - fl = 299.4KHz\) | \( BW = f'h - f'l =  399.55KHz\) |
| 4 | Mid-band Gain | \( A{v(mid)} = 12.88 \) | \( A'{v(mid)} = 8.40\) |
| 5 | Gain at half power point | G0= 9.40 | G0"=5.93 |
